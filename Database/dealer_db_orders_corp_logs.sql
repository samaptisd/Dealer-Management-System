...
--
-- Table structure for table `orders_corp_logs`
--

DROP TABLE IF EXISTS `orders_corp_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `orders_corp_logs` (
  `Sr_No` int NOT NULL,
  ...
  PRIMARY KEY (`Sr_No`,`Order_Id`,`Version_No`)
...
-- Dump completed on 2025-06-24 14:40:28
